...
use Podorozhny\Model\Frontend\User;
...
class UserProvider implements UserProviderInterface {
    ...
    public function refreshUser(SecurityUserInterface $user) {
        if (!$user instanceof User) {
            throw new UnsupportedUserException(sprintf('Expected an instance of Podorozhny\Model\Frontend\User, but got "%s".', get_class($user)));
        }
        ...
        if (null === $reloadedUser = $this->userManager->findById($user->getId())) {
